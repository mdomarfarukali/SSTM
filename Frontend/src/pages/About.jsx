export default function About() {
  return (
    <div className="bg-brand-light min-h-screen px-6 md:px-16 py-20 font-serif">
      {/* 💖 Header Section */}
      <section className="text-center mb-20">
        {/* <br></br>
        <br></br> */}
        <h1 className="text-5xl md:text-6xl font-extrabold text-brand-muted mb-4 tracking-wide">
        ...
        <p className="text-lg text-brand dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="max-w-6xl mx-auto mb-24 grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-4">
          <h2 className="text-3xl font-bold text-brand-muted">
            Our Story
          </h2>
        ...
        <img
          ...
          className="rounded-3xl shadow-2xl w-full border-4 border-brand hover:scale-[1.02] transition-transform duration-500"
        />
      </section>

      {/* 👑 Founders Section */}
      <section className="max-w-7xl mx-auto text-center mb-24">
        <h2 className="text-4xl font-bold text-brand-muted mb-12">
          Meet Our Founders
        </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          {[
            ...
            <div
              key={index}
              className="bg-brand p-8 rounded-3xl shadow-md hover:shadow-2xl border border-pink-100 dark:border-gray-700 transition-all duration-500"
            >
              <img
                src={founder.img}
                alt={founder.name}
              ...
              />
              <h3 className="text-2xl font-bold text-brand-muted mb-1">
                {founder.name}
              </h3>
      ...
      {/* ✨ Mission Section */}
      <section className="max-w-5xl mx-auto text-center bg-brand px-10 py-16 rounded-3xl shadow-inner border border-pink-200 dark:border-gray-700">
        <h2 className="text-3xl font-bold text-brand-muted mb-6">
          Our Mission
        </h2>
